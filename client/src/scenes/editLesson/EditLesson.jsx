      ...
      {lessonToUpdate && (
        <>
          <div className="edit-lesson-container">
            ...
            <form
              onSubmit={() => handleEditLesson(lessonToUpdate?._id)}
              className="form-update-lesson"
            >
              ...
              <FormControl variant="standard" sx={{ m: 1 }}>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setValues({
                      ...values,
                      cards: e.target.value.replace(' ', '').split(','),
                    })
                  }
                />
          ...
          <div className="list-card-to-edit">
            ...
            {!allCards && <div className="no-card">No cards be created</div>}
          </div>
        </>
      )}

      {!lessonToUpdate && <div>Not found lesson</div>}
    </>
  );
};
