  ...
  return (
    <>
      <div className="add-lesson-form-container">
        <div className="add-lesson-form-header">Add new lesson</div>
        <form className="form-add-lesson-main" onSubmit={handleAddLesson}>
          ...
          >
            Do you want to add any card to this lesson?
          </Button>
      ...
      <div className="list-card-choice-contain">
        ...
        {!_cards && <div className="no-card">No cards be created</div>}
      </div>
    </>
  );
};
