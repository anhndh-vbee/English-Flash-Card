...
const AddCardForm = () => {
    ...
    const _lessons = useSelector(state => state.lessons.allLessons?.listLessons);
    ...
    return (
        <>
            <div className="form-add-card-container">
                <div className="form-add-card-header">
                    Add new card
                </div>
                <form className="form-add-card-main" onSubmit={handleAddNewCard}>
                    ...
                    <Button className="btn-add-lesson-choice" variant='contained' color="warning" onClick={handleShowAddLesson}>Do you want to add card to any lesson?</Button>
                    ...
                    <Button type='submit' className="btn-add-card" variant="contained" color="success">Add</Button>
                </form>
            </div>
